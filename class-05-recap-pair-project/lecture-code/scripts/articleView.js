...
articleView.initNewArticlePage = function() {
    // Show the HTML form
    $('.tab-content').show();
    $('#export-field').hide();//hiding line 72-76
    // Hide export field (but show it later when article content exists)syntax looking things

    // Add event handlers
    //   . Highlight selected input area
    //   . Update article (live preview) when you click away or change status
